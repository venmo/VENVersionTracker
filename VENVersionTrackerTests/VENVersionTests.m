...
- (void)testVersionCreation {
    VENVersion *version2_0      = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_2_0];
    VENVersion *version1_1      = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_1_1];
    VENVersion *version1_2_0_a2 = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_1_2_a2];
    VENVersion *version1_2_0_b1 = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_1_2_b1];
    
    VENVersion *version_inv_empty   = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_INV_EMPTY];
    VENVersion *version_inv_types   = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_INV_TYPES];
...
- (void)testVersionComparison {
    VENVersion *version2_0      = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_2_0];
    VENVersion *version1_1      = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_1_1];
    VENVersion *version1_0_1    = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_1_0_1];
    VENVersion *version1_2_0_a  = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_1_2_a];
    VENVersion *version1_2_0_a2 = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_1_2_a2];
    VENVersion *version1_2_0_b1 = [[VENVersion alloc] initWithJSONPayload:VEN_TEST_VERSION_DICT_1_2_b1];
