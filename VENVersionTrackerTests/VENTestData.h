...
#define VEN_TEST_INSTALL_URL_1_2_ax   @"http://install_url_1_2_ax"
#define VEN_TEST_INSTALL_URL_1_2     @"http://install_url_1_2"
...
#define VEN_TEST_VERSION_NAME_1_2       @"1.2.0"
#define VEN_TEST_VERSION_NAME_1_2_a     @"1.2.0a1"
#define VEN_TEST_VERSION_NAME_1_2_ax    @"1.2.0ax"
...
#define VEN_TEST_VERSION_DICT_1_2     @{@"number": VEN_TEST_VERSION_NAME_1_2, @"install_url": VEN_TEST_INSTALL_URL_1_2, @"mandatory": @(NO)}
...
#define VEN_TEST_VERSION_DICT_1_2_ax     @{@"number": VEN_TEST_VERSION_NAME_1_2_ax, @"install_url": VEN_TEST_INSTALL_URL_1_2_ax, @"mandatory": @(NO)}
